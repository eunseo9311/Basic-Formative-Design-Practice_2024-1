...
// Exercise 16-6: Instead of replacing the background with green pixels, 
//replace it with another image. 
//What values work well for threshold and what values do not work at all? 
//Try controlling the threshold variable with the mouse.   
...
//When you get to running this example, step out of the frame, 
//click the mouse to memorize the background without you in it,
//and then step back into the frame, you will see the best result.