...
//Caculating the average brightness of an image by taking the sum of
//each pixel's brightness and deviding it by the total number of pixels.
//average brightness=total brightness/total number of pixels
//Calculating the average motion the same way:
//average motion=total motion/total number of pixels

//Display a circle that changes color and size based on
